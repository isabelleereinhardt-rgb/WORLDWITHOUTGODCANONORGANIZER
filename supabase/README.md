...
### The community tables

The second half of the schema is the public side; the Wattpad/AO3 half.
Everything above stays private; these are meant to be read by strangers:
...
| `community_progress` | Where each signed-in reader stopped. Private. |
| `community_posts` | The Rooms; shared discussion threads. |
